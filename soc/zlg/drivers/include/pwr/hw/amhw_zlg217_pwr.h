...
typedef enum amhw_zlg217_pvd_lever_set {
    AMHW_ZLG217_PVD_LEVER_1_8V  = 0,  /**< \brief 1.8V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_2_1V  = 1,  /**< \brief 2.1V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_2_4V  = 2,  /**< \brief 2.4V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_2_7V  = 3,  /**< \brief 2.7V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_3_0V  = 4,  /**< \brief 3.0V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_3_3V  = 5,  /**< \brief 3.3V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_3_6V  = 6,  /**< \brief 3.6V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_3_9V  = 7,  /**< \brief 3.9V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_4_2V  = 8,  /**< \brief 4.2V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_4_5V  = 9,  /**< \brief 4.5V PVD监测电压 */
    AMHW_ZLG217_PVD_LEVER_4_8V  = 10, /**< \brief 4.8V PVD监测电压 */
...
typedef enum amhw_zlg217_pwr_status_flag {
    AMHW_ZLG217_PVD_OUTPUT_FLAG  = (1UL << 2),  /**< \brief PVD输出标志位 */
    AMHW_ZLG217_PVD_SBF_FLAG     = (1UL << 1),  /**< \brief 待机标志位 */
    AMHW_ZLG217_PVD_WUF_FLAG     = (1UL << 0),  /**< \brief 唤醒标志位 */
} amhw_zlg217_pwr_status_flag_t;

/**
 * \brief 深度掉电模式选择
 * \param[in] pdds_mode    ：  深度掉电模式类型,值为  AM_ZLG217_PDDS_*_MODE 这一类宏
 ...
 * \brief PVD电压监测使能
 * \param[in] p_hw_pwr    ：指向电源控制寄存器块的指针
 * \param[in] pvd_enable  ：电压监测使能，值为  AM_ZLG217_PVDE_* 这一类宏
 ...
 * \brief 后备区域的写保护
 * \param[in] p_hw_pwr    ：指向电源控制寄存器块的指针
 * \param[in] bkp_enable  ：电压监测使能，值为  AM_ZLG217_BKP_* 这一类宏
 ...
 * \brief 清除待机标志位与唤醒位
 * \param[in] p_hw_pwr    ：指向电源控制寄存器块的指针
 * \param[in] status_flg  ：标志位清除选择，值为  AM_ZLG217_*_FLAG_CLEAR 这一类宏
 ...
 * \brief PV监测电压选择
 * \param[in] p_hw_pwr ：指向电源控制寄存器块的指针
 * \param[in] pvd_lever：电压监测范围选择, 值为 amhw_zlg217_pvd_lever_set_t 这一枚举类型的值
 *
 * \return 无
 */
am_static_inline
 ...
 * \brief 使能WAKE_UP引脚
 * \param[in] p_hw_pwr ：指向电源控制寄存器块的指针
 * \param[in] wakeup_en：唤醒引脚使能与否，值为 AM_ZLG217_WAKEUP_* 这一类宏，
 ...
 * \brief 获取电源控制相关状态位
 * \param[in] p_hw_pwr   ：指向电源控制寄存器块的指针
 * \param[in] status_flag：电源控制状态位，值为 amhw_zlg217_pwr_status_flag_t 这一枚举类型
 *
