...
#ifndef __AM_lpc845_BOOT_FLASH_H
#define __AM_lpc845_BOOT_FLASH_H
#include "hw/amhw_lpc84x_iap.h"
#include "am_boot.h"
#include "am_boot_flash.h"

typedef struct am_lpc845_boot_flash_devinfo {
...
} am_lpc845_boot_flash_devinfo_t;

typedef struct am_lpc845_boot_flash_dev {
    ...
    am_lpc845_boot_flash_devinfo_t *p_devinfo;      /**< \brief 设备信息结构体 */
}am_lpc845_boot_flash_dev_t;
...
#endif /* __AM_lpc845_BOOT_FLASH_H */
