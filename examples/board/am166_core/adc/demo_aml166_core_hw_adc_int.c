 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_hw_adc_int.c src_aml166_core_hw_adc_int
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_hw_adc_int
 * \copydoc demo_aml166_core_hw_adc_int.c
 */

/** [src_aml166_core_hw_adc_int] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo aml166_core hw adc int!\r\n");
