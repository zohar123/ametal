...
/**
 * \addtogroup demo_if_am159_core_hw_tim_pwm_dead
 * \copydoc demo_am159_core_hw_tim_pwm_dead.c
 */

/** [src_am159_core_hw_tim_pwm_dead] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
 ...
 * \brief 例程入口
 */
void demo_am159_core_hw_tim_pwm_dead_entry (void)
{
