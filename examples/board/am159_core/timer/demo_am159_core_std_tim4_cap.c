 ...
 *
 * \par 源代码
 * \snippet demo_am159_core_std_tim14_cap.c src_am159_core_std_tim14_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_am159_core_std_tim14_cap
 * \copydoc demo_am159_core_std_tim14_cap.c
 */

/** [src_am159_core_std_tim14_cap] */
#include "ametal.h"
#include "am_pwm.h"
#include "am_vdebug.h"
 ...
 * \brief 例程入口
 */
void demo_am159_core_std_tim14_cap_entry (void)
{
    am_pwm_handle_t pwm_handle = am_zmf159_tim2_pwm_inst_init();

    AM_DBG_INFO("demo am159_core std tim14 cap!\r\n");
